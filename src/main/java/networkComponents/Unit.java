...
public abstract class Unit implements Node {
    ...
    Unit(ComputeBehaviour computeBehaviour, Node node) {
    ...
    private ComputeBehaviour computeBehaviour;
    ...
    public String toString() {
        ...
        return String.format(template, getId(), getLabels(), getAllProperties());
    }
}
